...
import TeacherChoreographyVideoModal from '../../components/teachers/TeacherChoreographyVideoModal';
import ConfirmationModal from '../../components/ui/ConfirmationModal';
import '../teachers/ChoreographyVideos.css';

const TeacherChoreography = () => {
        ...
        <div className="choreography-page">
            <div className="theory-page-header">
                <div className="theory-page-header-content">
                    <div className="theory-page-header-left">
                        ...
                        <div>
                            <h1 className="theory-page-header-title">Choreography Videos</h1>
                            <p className="theory-page-header-subtitle">Manage and showcase your dance choreography videos</p>
                        </div>
                    </div>
            ...
            <div className="theory-section" style={{ marginTop: '0' }}>
                <div className="theory-section-header">
                    <h2 className="theory-section-title">My Videos</h2>
...
export default TeacherChoreography;
