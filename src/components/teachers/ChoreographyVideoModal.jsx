...
import './ChoreographyVideoModal.css';

const ChoreographyVideoModal = ({ isOpen, onClose, onSave, videoData }) => {
            ...
            <div className="video-modal-content" onClick={(e) => e.stopPropagation()}>
                <div className="video-modal-header">
                    <h3 className="video-modal-title">
                        {videoData ? 'Edit Choreography Video' : 'Add Choreography Video'}
                    </h3>
...
export default ChoreographyVideoModal;
